...
public class Post06_ObjMapper_Pojo extends DummyRestApiBaseUrl {
          /*
   ...
   Given
    ...
    public void post01() {
        ...
        //DummyRestApiReponseBodyPojo expectedData = new DummyRestApiReponseBodyPojo("success",new DummyRestApiDataPojo(),"Successfully! Record has been added.");
        ...
        //assertEquals("Successfully! Record has been added.",actualData.getMessage()); //=> Hard Coding
